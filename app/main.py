...
class IndovinaGiocatore(App):
    ...
    def build(self):
        ...
        self.etichetta = Label(
            text="Fai click su prossimo per iniziare ...",
            font_size='18sp',
            color='#ffffff'
            )
    ...
    def trovaTrasferimentiGiocatore(self, instance):
        if len(self.diz) > 0:
            ...
            self.etichetta.text = trasferimenti
